...
- Therefore, we can assume that the model already puts together that monkeys eat bananas and that is why there is a significant similarity.
...
sentence_to_compare = "Why is my crocodile on my sofa"
sentences = ["where did my crocodile go",
"Hello, there is my sofa",
"I\'ve lost my sofa in my sofa",
"I\'d like my car back",
"I will name my crocodile Henry"]
